...
class BankAccountsControllerTest < ActionController::TestCase
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post :create, bank_account: { accountname: @bank_account.accountname, bankname: @bank_account.bankname, over: @bank_account.over }
    end
  ...
  test "should update bank_account" do
    put :update, id: @bank_account, bank_account: { accountname: @bank_account.accountname, bankname: @bank_account.bankname, over: @bank_account.over }
    assert_redirected_to bank_account_path(assigns(:bank_account))
  end
