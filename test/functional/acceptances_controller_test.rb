...
class AcceptancesControllerTest < ActionController::TestCase
  ...
  test "should create acceptance" do
    assert_difference('Acceptance.count') do
      post :create, acceptance: { bank: @acceptance.bank, expire: @acceptance.expire, money: @acceptance.money, unit: @acceptance.unit }
    end
  ...
  test "should update acceptance" do
    put :update, id: @acceptance, acceptance: { bank: @acceptance.bank, expire: @acceptance.expire, money: @acceptance.money, unit: @acceptance.unit }
    assert_redirected_to acceptance_path(assigns(:acceptance))
  end
